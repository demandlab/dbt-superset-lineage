        ...
        "columns": [
            {
                ...
                "id": 10,
                "expression": None,
                "description": "ss_desc_db",
                "verbose_name": "SS Label DB",
            },
            {
                "column_name": "col_calc",
                "id": 11,
                "expression": "1+1",
                "description": "ss_desc_calc",
                "verbose_name": "SS Label Calc",
            },
            {
                "column_name": "col_only_ss",
                "id": 12,
                "expression": None,
                "description": "ss_desc_only",
                "verbose_name": "SS Label Only",
            },
        ],
